...
function Onboarding() {
  ...
  const { data: authData, isLoading: authLoading } = useQuery({
    queryKey: ["auth-user"],
    queryFn: () => api.get<{ user: { id: string } | null }>("/auth/user"),
    retry: false,
  });
  ...
  if (authLoading || (!authLoading && authData?.user === null)) {
    return (
      ...
      <header className="border-b border-border bg-card">
        ...
        <div className="h-1 w-full bg-secondary">
          <div
            ...
            style={{ width: pct + "%", backgroundImage: "var(--gradient-hero)" }}
          />
        </div>
      </header>
        ...
        {step === 2 && (
          <section className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <FieldSelect
                label="School size"
                options={["1 – 100", "100 – 500", "500 – 2,000", "2,000 – 10,000", "10,000+"]}
                value={schoolSize}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              >
                ...
                <div className="mt-1 text-sm text-muted-foreground">
                  school.elimu.africa — ready instantly.
                </div>
              </button>
              <button
              ...
              >
                ...
                <div className="mt-1 text-sm text-muted-foreground">
                  e.g. myschool.edu.ng — DNS guided.
                </div>
              </button>
            </div>
          ...
          <section className="space-y-5">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                We'll create your starter accounts and you're ready.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <ul className="mt-4 space-y-3 text-sm">
                {[
                  ...
                  <li
                    key={e}
                    className="flex items-center justify-between rounded-lg bg-secondary px-3 py-2 font-mono"
                  >
            ...
            <div className="rounded-2xl border border-border bg-card p-5 text-sm">
              ...
              <p className="mt-1 text-muted-foreground">
                Use CSV upload from the admin dashboard to provision the rest of your students and
                teachers in one go.
              </p>
            </div>
            {error && (
